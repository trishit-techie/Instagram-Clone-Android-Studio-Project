            ...
            try{
                ...
                object.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e == null){
                            Toast.makeText(UserListActivity.this, "Image has been successfully uploaded", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            Toast.makeText(UserListActivity.this,"Sorry! Image could not be uploaded",Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
